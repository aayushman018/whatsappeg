...
Super Collection Whatsapp Intelligence is an in-house communication command center for lead handling, customer support, AI-assisted WhatsApp replies, and operational analytics.

This repository contains everything needed to run and deploy the platform.
